...
Route::get('/produtos/editar/{id}', 'App\Http\Controllers\ProdutosController@edit')->name('alterar_produto');
Route::post('/produtos/novo', 'App\Http\Controllers\ProdutosController@edit')->name('alterar_produto');
